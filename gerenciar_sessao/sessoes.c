...
#include "sessoes.h"  // Inclui nosso próprio "cardápio" para implementar as funções

// --- Constantes ---
// Definir nomes de arquivos como constantes é uma boa prática.
// Se precisar mudar o nome, você só muda em um lugar.
#define ARQUIVO_SESSOES "sessoes.dat"
#define ARQUIVO_CONTADOR "contador_sessao.dat"


// --- Funções Auxiliares (Privadas) ---
// Esta função só é usada por este módulo, por isso não está no .h
...
void cancelarSessao() {
    ...
    // --- FASE 4: Limpeza ---
    // SEMPRE libere a memória que você alocou!
